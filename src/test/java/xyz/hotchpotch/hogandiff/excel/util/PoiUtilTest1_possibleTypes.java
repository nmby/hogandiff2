...
class PoiUtilTest1_possibleTypes {
    ...
    void testPossibleTypes_xls形式() {
        // TODO: 「1_ワークシート」「2_グラフ」「4_マクロ」を見分ける術が分からない。
        assertEquals(
    ...
    void testPossibleTypes_xlsm形式() {
        // TODO: 「1_ワークシート」と「4_マクロ」を見分ける術が分からない。
        assertEquals(
        ...
        // TODO: どういう訳か .xlsm 形式のExcelブックから「3_ダイアログ」を読み込めない。
        ...
        // TODO: どういう訳か .xlsm 形式のExcelブックから「4_マクロ」を読み込めない。
